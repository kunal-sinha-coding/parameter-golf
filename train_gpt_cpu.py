...
class Hyperparameters:
    ...
    max_wallclock_seconds = 0.0 #float(os.environ.get("MAX_WALLCLOCK_SECONDS", 600.0))
...
def main() -> None:
    ...
    log0(f"Running on device {device}", console=False)
    log0("=" * 100, console=False)
    ...
    log0("attention_backend:cpu_math")
    ...
    log0("device_memory_stats: unavailable on cpu")
